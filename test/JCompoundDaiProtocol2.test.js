...
describe('JProtocol', function () {
  ...
  it("user1 buys some token EthTrA", async function () {
    ...
    console.log((await this.JCompound.getCompoundNormalizedPrice(1)).toString());
    trPar = await this.JCompound.trancheParameters(1);
    console.log("param tranche A: " + JSON.stringify(trPar));
    console.log("rpb tranche A: " +  await this.JCompound.getTrancheACurrentRPB(1));
    tx = await this.JCompound.calcNormalizedRPBFromPercentage(1, {from: user1});
    console.log("rpb tranche A: " +  await this.JCompound.getTrancheACurrentRPB(1));
    ...
    console.log("JCompound cDAI balance: "+ web3.utils.fromWei(await this.JCompound.getTokenBalance(this.CErc20.address), "ether") + " cDai");
    console.log("TrA price: " +  web3.utils.fromWei(await this.JCompound.getTrancheAExchangeRate(1), "ether"));
    console.log("Compound Price: " + await this.JCompound.getCompoundNormalizedPrice(1));
    console.log("Compound TrA Value: " + web3.utils.fromWei(await this.JCompound.getTrANormalizedValue(1), "ether"));
    console.log("Compound total Value: " + web3.utils.fromWei(await this.JCompound.getTotalNormalizedValue(1), "ether"));
  }); 
  ...
  it("user1 buys some token EthTrB", async function () {
    ...
    console.log("TrB value: " +  web3.utils.fromWei(await this.JCompound.getTrBNormalizedValue(1), "ether"));
    console.log("Compound total Value: " + web3.utils.fromWei(await this.JCompound.getTotalNormalizedValue(1), "ether"));
    console.log("TrB total supply: " + web3.utils.fromWei(await this.DaiTrB.totalSupply(), "ether"));
    console.log("Compound TrA Value: " + web3.utils.fromWei(await this.JCompound.getTrANormalizedValue(1), "ether"));
    console.log("TrB price: " + web3.utils.fromWei(await this.JCompound.getTrancheBNormalizedExchangeRate(1, web3.utils.toWei("10000", "ether")), "ether"));
    tx = await this.DAI.approve(this.JCompound.address, web3.utils.toWei("10000", "ether"), {from: user1});
    ...
    console.log("CErc20 DAI balance: "+ web3.utils.fromWei(await this.DAI.balanceOf(this.CErc20.address), "ether") + " DAI");
    console.log("JCompound DAI balance: "+ web3.utils.fromWei(await this.JCompound.getTokenBalance(this.CErc20.address), "ether") + " cDai");
    console.log("TrB price: " + web3.utils.fromWei(await this.JCompound.getTrancheBNormalizedExchangeRate(1, 0), "ether"));
    console.log("Compound price: " + web3.utils.fromWei(await this.JCompound.getCompoundNormalizedPrice(1), "ether"));
    console.log("TrA price: " +  web3.utils.fromWei(await this.JCompound.getTrancheAExchangeRate(1), "ether"));
    console.log("Compound TrA Value: " + web3.utils.fromWei(await this.JCompound.getTrANormalizedValue(1), "ether"));
    console.log("TrB value: " +  web3.utils.fromWei(await this.JCompound.getTrBNormalizedValue(1), "ether"));
    console.log("Compound total Value: " + web3.utils.fromWei(await this.JCompound.getTotalNormalizedValue(1), "ether"));
  ...
  it("user1 redeems token EthTrB", async function () {
    ...
    console.log("CErc20 DAI balance: "+ web3.utils.fromWei(await this.DAI.balanceOf(this.CErc20.address), "ether") + " DAI");
    console.log("JCompound new DAI balance: "+ web3.utils.fromWei(await this.JCompound.getTokenBalance(this.CErc20.address), "ether") + " cDai");
    console.log("TrA Value: " + web3.utils.fromWei(await this.JCompound.getTrANormalizedValue(1), "ether"));
    console.log("TrB value: " +  web3.utils.fromWei(await this.JCompound.getTrBNormalizedValue(1), "ether"));
    console.log("Compound total Value: " + web3.utils.fromWei(await this.JCompound.getTotalNormalizedValue(1), "ether"));
  }); 
